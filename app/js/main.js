...
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/fslightbox */ "./src/js/components/fslightbox.js");
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_fslightbox__WEBPACK_IMPORTED_MODULE_6__);
...
const modals = new _functions_modals__WEBPACK_IMPORTED_MODULE_0__["default"](options);
modals.init();
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.projects__slider', {
  spaceBetween: 50,
  speed: 500,
  navigation: {
  ...
  if (tabTriggerNodes.length > 0) {
    tabTriggerNodes.forEach(triggerNode => {
      triggerNode.addEventListener('click', function (e) {
        ...
        const id = triggerNode.closest('.services__item').getAttribute('data-tabs');

        if (activeNode) {
          activeNode.classList.remove('is-active');
        }

        const clickedNode = document.querySelector('.services__item[data-tabs="' + id + '"]');
