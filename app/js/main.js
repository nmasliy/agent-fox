...
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/fslightbox */ "./src/js/components/fslightbox.js");
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_fslightbox__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_validation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/validation */ "./src/js/components/validation.js");
/* harmony import */ var _components_fullpage_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/fullpage-scroll */ "./src/js/components/fullpage-scroll.js");
/* harmony import */ var _components_fullpage_scroll__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_fullpage_scroll__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/animations */ "./src/js/components/animations.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_full_page_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/full-page-scroll */ "./src/js/vendor/full-page-scroll.js");
/* harmony import */ var _vendor_full_page_scroll__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_full_page_scroll__WEBPACK_IMPORTED_MODULE_0__);
// Vendor local files
...
function initAnimations() {
  ...
  if (window.innerWidth > _vars__WEBPACK_IMPORTED_MODULE_0__.MOBILE_BREAKPOINT) {
    // В моб. версии фон анимируется снизу, в ПК - справа
    tl.from(".hero__bg-img-wrapper", {
      x: 1000,
      filter: "blur(50px)",
      duration: 0.5,
      ease: "power2.out"
  ...
  tl.from(".hero__bg-title--2", {
    y: "-200%",
    duration: 0.5,
    ease: "power2.out"
  }, '-=0.2');
  tl.from(".hero__bg-title--1", {
    y: "-200%",
    duration: 0.5,
    ease: "power2.out"
  }, '-=0.5');
  ...
  if (window.innerWidth > _vars__WEBPACK_IMPORTED_MODULE_0__.MOBILE_BREAKPOINT) {
    // Анимируем навигацию только в ПК версии
  ...
  if (window.innerWidth > 768) {
    // Мотоцикл виден только только при > 768, поэтому анимируем только в этом случае
    tl.from(".hero__img", {
      x: "-100vw",
      filter: "blur(4px)",
      duration: 0.7,
  ...
  tl.from(".hero__btn-wrapper", {
    scale: 0,
    duration: 0.3,
    ease: "power2.out"
  }, '-=0.3').then(() => heroSection.dataset.animated = true);
  fullpage.onSlideChangeCustom = _ref => {
    let {
      fromPosition,
      toPosition
    } = _ref;
    // Анимация появления и исчезания первого экрана
    ...
    if (toPosition === 0) gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(".arrow-up", {
      opacity: 0
    });else gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(".arrow-up", {
      opacity: 1
    });
  };
  navListItemNodes.forEach(listItemNode => {
    // Анимация первого экране при навигации по секциям через меню
...
if (+fullpage.defaults.currentPosition !== 0) {
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(".arrow-up", {
    opacity: 1
  });
}
...
/***/ "./src/js/components/fullpage-scroll.js":
/*!**********************************************!*\
  !*** ./src/js/components/fullpage-scroll.js ***!
  \**********************************************/
/***/ (() => {
...
const projectsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](projectsSliderNode, {
  spaceBetween: 50,
  speed: 800,
  navigation: {
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contacts-form', rules, afterSend);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#modal-contact .modal__form', rulesContacts, afterSend);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#modal-tender .modal__form', rulesTender, afterSend);
...
(function () {
  ...
  const checkScreenWidth = () => {
    ...
    if ($menu && window.innerWidth <= _vars__WEBPACK_IMPORTED_MODULE_0__.MOBILE_BREAKPOINT && !isInit) {
      isInit = true;
...
const validateForms = (selector, rules, afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('+7 (9999) 99-99-99');
...
/***/ "./src/js/vendor/full-page-scroll.js":
/*!*******************************************!*\
  !*** ./src/js/vendor/full-page-scroll.js ***!
  \*******************************************/
/***/ (() => {
...
(function () {
  ...
  fullScroll.prototype.buildPublicFunctions = function () {
    ...
    this.mouseWheelAndKey = function (event) {
      if (document.querySelector('.disable-scroll') || !document.querySelector('.hero').dataset.animated || _self.defaults.isAnimate) return;
      ...
      if (location) {
        ...
        if (anchor !== "") {
          if (anchor == 0) {
            ...
            _self.defaults.onSlideChange({
              fromPosition: _self.defaults.currentPosition,
              toPosition: anchor
            });
            _self.defaults.currentPosition = anchor;
            _self.animateScroll();
